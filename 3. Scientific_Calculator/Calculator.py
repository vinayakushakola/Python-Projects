...
def buttonXN():
    global operator
    screenText.set(f'{operator}**')
    operator = operator +'**'

def buttonFact():
    global operator
    screenText.set(factorial(int(operator)))

# sin(m.radians(2))
def buttonSin():
    global operator
    screenText.set(eval(f"sin(radians({operator}))"))
def buttonCos():
    global operator
    screenText.set(eval(f"cos(radians({operator}))"))
def buttonTan():
    global operator
    screenText.set(eval(f"tan(radians({operator}))"))
def buttonLog():
    pass
def buttonExp():
    pass
...
def menuButton():
    ...
    options.add_command(label="Standard", command=Standard)
    options.add_separator()
    options.add_command(label="Scientific", command=Scientific)
    menuBar.add_cascade(label="Options", menu=options)
    menuBar.add_cascade(label="About", command=aboutMe)
...
def Standard():
    ...
    CE = tk.Button(mainFrame, text="CE", font="helvetica", width=5, pady=5, relief="groove", command=clearall)
    CE.grid(row=3, column=0, pady=(0, 5))
    C = tk.Button(mainFrame, text="C", font="helvetica", width=5, pady=5, relief="groove", command=clearall)
    ...
    sym = tk.Button(mainFrame, text="±", font="helvetica", width=5, pady=5, relief="groove", command=plusMinus)
...
def Scientific():
    ...
    per = tk.Button(mainFrame, text="CE", font="helvetica", width=5, pady=5, relief="groove", command=clearall)
    per.grid(row=2, column=0, pady=(0, 5), padx=(0, 5))
    sroot = tk.Button(mainFrame, text="sin", font="helvetica", width=5, pady=5, relief="groove", command=buttonSin)
    sroot.grid(row=2, column=1, pady=(0, 5), padx=(0, 5))
    sqr = tk.Button(mainFrame, text="cos", font="helvetica", width=5, pady=5, relief="groove", command=buttonCos)
    sqr.grid(row=2, column=2, pady=(0, 5), padx=(0, 5))
    byx = tk.Button(mainFrame, text="tan", font="helvetica", width=5, pady=5, relief="groove", command=buttonTan)
    ...
    CE = tk.Button(mainFrame, text="C", font="helvetica", width=5, pady=5, relief="groove", command=clearall)
    CE.grid(row=3, column=0, pady=(0, 5), padx=(0, 5))
    CE = tk.Button(mainFrame, text="log", font="helvetica", width=5, pady=5, relief="groove", command=buttonLog)
    CE.grid(row=3, column=1, pady=(0, 5), padx=(0, 5))
    CE = tk.Button(mainFrame, text="Exp", font="helvetica", width=5, pady=5, relief="groove", command=buttonExp)
    CE.grid(row=3, column=2, pady=(0, 5), padx=(0, 5))
    CE = tk.Button(mainFrame, text="Mod", font="helvetica", width=5, pady=5, relief="groove", command=buttonMod)
    ...
    CE = tk.Button(mainFrame, text="π", font="helvetica", width=5, pady=5, relief="groove", command=lambda: buttonClick("3.14"))
